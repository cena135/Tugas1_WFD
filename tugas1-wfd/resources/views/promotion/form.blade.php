...
<form action="{{ route('promotion.store') }}" method="POST" enctype="multipart/form-data" class="max-w-sm mx-auto">
  @csrf
  <h1 class="text-2xl font-bold mb-5">Create promotion</h1>
    <div class="mb-5">
